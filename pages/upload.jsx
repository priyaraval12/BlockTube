...
import saveThumnail from "../utils/saveThumnail";
...
export default function Upload() {
  ...
  async function handleSubmit() {
    ...
    let VIDEO_HASH = await saveVideo(video);
    let UploadedDate = String(new Date());
    let contract = useContract();
    toast.update(toastMessage, {
      render: "Plase Sign Message...",
      type: "default",
      isLoading: true,
    });
    let addtochain = await contract.uploadVideo(
      VIDEO_HASH,
      title,
      description,
      location,
